...
<template>
  ...
  <div class="flex flex-col px-60 h-svh justify-start gap-8 mt-10">
    <div class="flex flex-col gap-3">
      ...
      <p class="text-[#4A739C]">Welcome back {{authStore.user.username}}, Here's a summary of your recent activity.</p>
    </div>
    <div class="flex flex-row justify-between">
        ...
        <div class="w-80 h-24 b-1 rounded-xl border border-[#CFDBE8] p-6">
          ...
          <h3 class="font-bold text-2xl">{{compatibilityScore /  analysisStore.analyses.length}} %</h3>
        </div>
        <div class="w-80 h-24 b-1 rounded-xl border border-[#CFDBE8] p-6">
        ...
        <Button type="primary" to="" text="Start new Analysis" :block="false"></Button>
